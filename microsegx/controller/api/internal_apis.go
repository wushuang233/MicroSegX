...
type RESTK8sNvRbacStatus struct {
	...
	NvCrdSchemaErrors        []string                   `json:"microsegx_crd_errors,omitempty"`      // obsolete
	NvUpgradeInfo            *RESTCheckUpgradeInfo      `json:"microsegx_upgrade_info"`
...
type RESTK8sNvAcceptableAlerts struct {
	...
	NvCrdSchemaErrors        map[string]string `json:"microsegx_crd_errors"`      // key is hex(sha256) of the English message
...
type RESTNvAcceptableAlerts struct {
	...
	NvCrdSchemaAlerts        *RESTNvAlertGroup `json:"microsegx_crd_alerts,omitempty"`
...
type RESTNvAlert struct {
	ID      string `json:"id"` // ID is hex(sha256) of the English message
