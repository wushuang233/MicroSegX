...
const importBackupDir = "/etc/microsegx/"
...
func handlerSystemGetAlerts(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	// populate microsegx_upgrade_info
...
func importFedConfig(loginDomainRoles access.DomainRole, importTask share.CLUSImportTask,
	...
	if err := json.Unmarshal(json_data, &secRule); err != nil || secRule.APIVersion != "microsegx.com/v1" || secRule.Kind != resource.NvConfigSecurityRuleKind {
