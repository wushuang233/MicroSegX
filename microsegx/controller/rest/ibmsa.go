...
const (
	...
	_invalidDashboardURL = "Invalid URL. Configure this field from MicroSegX Console of the target cluster."
			...
			Notes: []ibmsaNote{
				{
					...
					ShortDescription: "MicroSegX Security Events",
					LongDescription:  "MicroSegX Container Security - Security Events",
					ReportedBy: ibmsaReporter{
						ID:    "MicroSegX",
						Title: "Microsegx Security Tool",
					},
					Card: &ibmsaCard{
						Section:          "Partner Integrations",
						Title:            "MicroSegX Security Report",
				...
				{
					Kind:             "FINDING",
					ShortDescription: "MicroSegX security threat finding",
					LongDescription:  "MicroSegX Container Security",
					ProviderID:       providerID,
...
func ibmsaPostThreatFinding(f *api.IBMSAFinding) error {
	...
	occur := ibmsaOccurrences{
		...
		Finding: &ibmsaFinding{
			...
			NextSteps: []ibmsaRemediationStep{
				{
					Title: fmt.Sprintf("%s - Correlate security events in the MicroSegX console to evaluate the scope of the attack", cacher.GetSystemConfigClusterName(accIBMSAPoster)),
					Url:   "https://docs.microsegx.com",
				},
			},
