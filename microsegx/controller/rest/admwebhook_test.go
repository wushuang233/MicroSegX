...
func TestParseReqImageName(t *testing.T) {
...

	{
		...
		testImages := []*testImage{
			{
				image:             "10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http",
				expectedRegistry:  "https://10.1.127.3:5000/",
				expectedImageRepo: "microsegx/toolbox/selvam_coreos_http",
				expectedImageTag:  "latest",
			},
			{
				image:             "10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http:RELEASE",
				expectedRegistry:  "https://10.1.127.3:5000/",
				expectedImageRepo: "microsegx/toolbox/selvam_coreos_http",
...
func TestScanEnvVarSecrets(t *testing.T) {
	...
	vars := map[string]string{
		...
		"env2":     "microsegx-svc-controller.microsegx",
