	...
	restCrtArr = []*api.RESTAdmRuleCriterion{
		{
			Name:  share.CriteriaKeyImageRegistry,
			Op:    share.CriteriaOpContainsAny,
			Value: "https://INDEX.docker.io, index.docker.io, https://localhost, 10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http, https://10.1.127.3:5000/microsegx",
		},
	}
...

	{
		restCrtArr := []*api.RESTAdmRuleCriterion{
			...
			},
			{
				Name:  share.CriteriaKeyImageRegistry,
				Op:    share.CriteriaOpContainsAny,
				Value: "10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http",
			},
			{
			...
			},
			{
				Name:  share.CriteriaKeyImageRegistry,
				Op:    share.CriteriaOpContainsAny,
				Value: "10.1.127.3:5000/microsegx",
			},
		}
...

	{
		restCrtArr := []*api.RESTAdmRuleCriterion{
			...
			},
			{
				Name:  share.CriteriaKeyImage,
				Op:    share.CriteriaOpContainsAny,
				Value: "10.1.127.3:5000/microsegx/scanner",
			},
			{
				Name:  share.CriteriaKeyImageVerifiers,
				Op:    share.CriteriaOpNotContainsAny,
		...
		expectedCrtArr := []*share.CLUSAdmRuleCriterion{
			...
			},
			{
				Name:  share.CriteriaKeyImage,
				Op:    share.CriteriaOpContainsAny,
				Value: "https://index.docker.io/iperf,https://10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http,https://10.1.127.3:5000/microsegx/scanner",
			},
			{
				Name:  share.CriteriaKeyCustomPath,
				Op:    share.CriteriaOpContainsAny,
...
func TestNormalizeImageValue(t *testing.T) {
	...
	input := map[string]string{
		...
		"10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http":        "https://10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http",
		"10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http:latest": "https://10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http:latest",
	...
	input = map[string]string{
		...
		"localhost:8080":         "https://localhost:8080/",
		"https://localhost:8080": "https://localhost:8080/",
		"10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http":        "https://10.1.127.3:5000/",
		"10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http:latest": "https://10.1.127.3:5000/",
...
func TestMatchImageValue(t *testing.T) {
	...
	crtValue := "https://10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http"
	testContainers := []*testContainer{
		{
			imageRegistry: "https://10.1.127.3:5000/",
			ImageRepo:     "microsegx/toolbox/selvam_coreos_http",
			ImageTag:      "latest",
			expectedMet:   true,
		},
		{
		...
		},
		{
			...
			ImageRepo:     "microsegx/selvam_coreos_http",
			ImageTag:      "latest",
			expectedMet:   false,
		},
	}
...
func TestIsImageCriterionMet(t *testing.T) {
	...
	crt := &share.CLUSAdmRuleCriterion{
		Name:  share.CriteriaKeyImage,
		Op:    share.CriteriaOpContainsAny,
		Value: "https://index.docker.io/library/ubuntu,https://10.1.127.3:5000/microsegx/toolbox/selvam_coreos_http",
	}
