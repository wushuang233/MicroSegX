...
const (
	NvDeploymentName = "microsegx-controller-pod"
	NvDaemonSetName  = "microsegx-allinone-pod"
)

const (
	nvOperatorsRole               = "microsegx-binding-co"
	nvOperatorsRoleBinding        = nvOperatorsRole
	NvAppRole                     = "microsegx-binding-app"
	nvAppRoleBinding              = NvAppRole
	NvRbacRole                    = "microsegx-binding-rbac"
	nvRbacRoleBinding             = NvRbacRole
	NvAdmCtrlRole                 = "microsegx-binding-admission"
	nvAdmCtrlRoleBinding          = NvAdmCtrlRole
	nvCrdRole                     = "microsegx-binding-customresourcedefinition"
	nvCrdRoleBinding              = nvCrdRole
	nvCrdSecRuleRole              = "microsegx-binding-nvsecurityrules"
	nvCrdSecRoleBinding           = nvCrdSecRuleRole
	nvCrdGrpDefRole               = "microsegx-binding-nvgroupdefinitions"
	nvCrdGrpDefRoleBinding        = nvCrdGrpDefRole
	nvCrdAdmCtrlRole              = "microsegx-binding-nvadmissioncontrolsecurityrules"
	nvCrdAdmCtrlRoleBinding       = nvCrdAdmCtrlRole
	nvCrdResponseRuleRole         = "microsegx-binding-nvresponserulesecurityrules"
	nvCrdResponseRuleRoleBinding  = nvCrdResponseRuleRole
	nvCrdDlpRole                  = "microsegx-binding-nvdlpsecurityrules"
	nvCrdDlpRoleBinding           = nvCrdDlpRole
	nvCrdWafRole                  = "microsegx-binding-nvwafsecurityrules"
	nvCrdWafRoleBinding           = nvCrdWafRole
	nvCrdVulnProfileRole          = "microsegx-binding-nvvulnerabilityprofiles"
	nvCrdVulnProfileRoleBinding   = nvCrdVulnProfileRole
	nvCrdCompProfileRole          = "microsegx-binding-nvcomplianceprofiles"
	nvCrdCompProfileRoleBinding   = nvCrdCompProfileRole
	NvScannerRole                 = "microsegx-binding-scanner"
	NvScannerRoleBinding          = NvScannerRole
	NvSecretRole                  = "microsegx-binding-secret"
	nvSecretRoleBinding           = NvSecretRole
	NvSecretControllerRole        = "microsegx-binding-secret-controller"
	nvSecretControllerRoleBinding = NvSecretControllerRole
	NvAdminRoleBinding            = "microsegx-admin"
	nvViewRoleBinding             = "microsegx-binding-view"
	NvJobCreationRole             = "microsegx-binding-job-creation"
	NvJobCreationRoleBinding      = NvJobCreationRole
	NvCertUpgraderRole            = "microsegx-binding-cert-upgrader"
...
const (
	nvCspUsageRole        = "microsegx-binding-csp-usages"
	nvCspUsageRoleBinding = nvCspUsageRole

	nvBootstrapSecret = "microsegx-bootstrap-secret"
	nvStoreSecret     = "microsegx-store-secret"
...
const (
	NsSelectorKeyStatusNV  = "statusMicrosegx" // written to only microsegx namespace's label
	NsSelectorKeySkipNV    = "skipMicrosegxAdmissionControl"
...
var NvAdmSvcName = "microsegx-svc-admission-webhook"
var NvCrdSvcName = "microsegx-svc-crd-webhook"
var NvAdmSvcNamespace = "microsegx"
var NvListKind = "List"
...
func xlateDaemonSet(obj metav1.Object) (string, interface{}) {
	if o, ok := obj.(*appsv1.DaemonSet); ok && o != nil {
		if o.GetNamespace() != NvAdmSvcNamespace || o.GetName() != "microsegx-enforcer-pod" {
			return "", nil
		}
		r := &DaemonSet{
			UID:    string(obj.GetUID()),
...
func (d *kubernetes) RegisterResource(rt string) error {
	...
	if rt == RscTypeImage {
		...
		case RscTypeCrdSecurityRule:
			k8s.Register("microsegx.com", "v1", NvSecurityRulePlural, true, &NvSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvSecurityRulePlural, true, &NvSecurityRuleList{})
		case RscTypeCrdClusterSecurityRule:
			k8s.Register("microsegx.com", "v1", NvClusterSecurityRulePlural, false, &NvClusterSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvClusterSecurityRulePlural, false, &NvClusterSecurityRuleList{})
		case RscTypeCrdGroupDefinition:
			k8s.Register("microsegx.com", "v1", NvGroupDefPlural, true, &NvGroupDefinition{})
			k8s.RegisterList("microsegx.com", "v1", NvGroupDefPlural, true, &NvGroupDefinitionList{})
		case RscTypeCrdAdmCtrlSecurityRule:
			k8s.Register("microsegx.com", "v1", NvAdmCtrlSecurityRulePlural, false, &NvAdmCtrlSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvAdmCtrlSecurityRulePlural, false, &NvAdmCtrlSecurityRuleList{})
		case RscTypeCrdResponseSecurityRule:
			k8s.Register("microsegx.com", "v1", NvResponseSecurityRulePlural, false, &NvResponseSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvResponseSecurityRulePlural, false, &NvResponseSecurityRuleList{})
		case RscTypeCrdDlpSecurityRule:
			k8s.Register("microsegx.com", "v1", NvDlpSecurityRulePlural, false, &NvDlpSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvDlpSecurityRulePlural, false, &NvDlpSecurityRuleList{})
		case RscTypeCrdWafSecurityRule:
			k8s.Register("microsegx.com", "v1", NvWafSecurityRulePlural, false, &NvWafSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvWafSecurityRulePlural, false, &NvWafSecurityRuleList{})
		case RscTypeCrdVulnProfile:
			k8s.Register("microsegx.com", "v1", NvVulnProfileSecurityRulePlural, false, &NvVulnProfileSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvVulnProfileSecurityRulePlural, false, &NvVulnProfileSecurityRuleList{})
		case RscTypeCrdCompProfile:
			k8s.Register("microsegx.com", "v1", NvCompProfileSecurityRulePlural, false, &NvCompProfileSecurityRule{})
			k8s.RegisterList("microsegx.com", "v1", NvCompProfileSecurityRulePlural, false, &NvCompProfileSecurityRuleList{})
...
func (d *kubernetes) addResource(rt string, res interface{}) error {
	...
	// Note: Currently(Jan./2019) we only support creating microsegx-validating-admission-webhook resource
...
func (d *kubernetes) deleteResource(rt string, res interface{}) error {
	...
	// Note: Currently(Jan./2019) we only support deleting microsegx-validating-admission-webhook resource
	obj, ok := res.(metav1.Object)
	if !ok {
		return ErrResourceNotSupported
	}
...
func AdjustAdmResForOC() {
	...
	// ocVersionMajor == 0 : if k8s RBAC microsegx-binding-co is missing, we cannot get oc version. In this case treat it as oc 4.x
...
func AdjustAdmWebhookName(f1 NvQueryK8sVerFunc, cspType_ share.TCspType) {
	...
	cspType = cspType_
	NvAdmMutatingWebhookName = fmt.Sprintf("%s.%s.svc", NvAdmMutatingName, NvAdmSvcNamespace)           // ex: microsegx-mutating-admission-webhook.microsegx.svc
	NvAdmValidatingWebhookName = fmt.Sprintf("%s.%s.svc", NvAdmValidatingName, NvAdmSvcNamespace)       // ex: microsegx-validating-admission-webhook.microsegx.svc
	NvCrdValidatingWebhookName = fmt.Sprintf("%s.%s.svc", NvCrdValidatingName, NvAdmSvcNamespace)       // ex: microsegx-validating-crd-webhook.microsegx.svc
	NvStatusValidatingWebhookName = fmt.Sprintf("%s.%s.svc", nvStatusValidatingName, NvAdmSvcNamespace) // ex: microsegx-validating-status-webhook.microsegx.svc
	GetK8sVersion()
...
func initNvRscMapForSSO() {
	...
	nvRscMapSSO = map[string]utils.Set{ // apiGroup -> microsegx permission resources
		"read-only.microsegx.api.io": nvPermitsRscSSO,
		"api.microsegx.com":          nvPermitsRscSSO,
		"permission.microsegx.com":   nvPermitsRscSSO,
		"*":                          nvPermitsRscSSO,
	}
}
...
func getMicrosegxSvcAccount() {
	...
	resInfo := map[string]string{ // resource object name : resource type
		"microsegx-updater-pod":          RscTypeCronJob,
		"microsegx-enforcer-pod":         RscTypeDaemonSet,
		"microsegx-scanner-pod":          RscTypeDeployment,
		"microsegx-registry-adapter-pod": RscTypeDeployment,
		"microsegx-cert-upgrader-pod":    RscTypeCronJob,
	}
	...
	for objName, rt := range resInfo {
		...
		case "microsegx-scanner-pod", "microsegx-registry-adapter-pod":
			if o, ok := obj.(*appsv1.Deployment); ok && o != nil {
				sa = "default"
				spec := o.Spec.Template.Spec
				if spec.ServiceAccountName != "" {
				...
				switch objName {
				case "microsegx-scanner-pod": // get scanner deployment service account
					scannerSubjectWanted = sa
				case "microsegx-registry-adapter-pod": // get registry-adapter deployment service account
	...
	if regAdapterSubjectWanted == "" {
		// it means microsegx-registry-adapter-pod is not deployed.
		// so the alert message for rolebinding microsegx-binding-secret will not containsa the "registry-adapter" sa
		regAdapterSubjectWanted = ctrlerSubjectWanted
	}
	if scannerSubjectWanted == "" {
		// it means microsegx-scanner-pod is not deployed.
		// so the alert message for rolebinding microsegx-binding-secret will not containsa the "scanner" sa
		scannerSubjectWanted = ctrlerSubjectWanted
	}
	if enforcerSubjectWanted == "" {
		// it means microsegx-enforcer-pod is not deployed.
		// so the alert message for rolebinding microsegx-binding-secret will not containsa the "enforcer" sa
...
func RetrieveBootstrapPassword() (string, error) {
	...
	if (err == nil && len(data) == 0) || strings.Index(err.Error(), "Failure 404 ") > 0 {
		...
		obj, err := global.ORCH.GetResource(RscTypeDeployment, NvAdmSvcNamespace, "microsegx-controller-pod")
		if err == nil {
			if deployObj, ok := obj.(*appsv1.Deployment); ok {
	...
	if err == nil {
		for _, obj := range pods {
			if pod, ok := obj.(*Pod); ok && pod != nil {
				if v, ok := pod.Labels["app"]; ok && v == "microsegx-controller-pod" {
