...
const RscCspUsageName = "microsegx-usage"

// ValidatingWebhookConfiguration resource instance (microsegx-validating-admission-webhook) contains 2 webhooks:
//  1. microsegx-validating-admission-webhook.microsegx.svc
//  2. microsegx-validating-status-webhook.microsegx.svc
var NvAdmMutatingName = "microsegx-mutating-admission-webhook"     // ValidatingWebhookConfiguration resource instance metadata name
var NvAdmValidatingName = "microsegx-validating-admission-webhook" // ValidatingWebhookConfiguration resource instance metadata name
var NvCrdValidatingName = "microsegx-validating-crd-webhook"       // ValidatingWebhookConfiguration resource instance metadata name
var nvStatusValidatingName = "microsegx-validating-status-webhook" // for composing webhook name only, not for ValidatingWebhookConfiguration resource instance metadata name
var NvPruneValidatingName = "microsegx-prune-orphan-crd-groups"    // for manually pruning orphan crd groups only
...
type AdmissionWebhookConfiguration struct {
	...
	Name    string // k8s resource metadata name, like "microsegx-validating-admission-webhook" or "microsegx-validating-crd-webhook"
}
