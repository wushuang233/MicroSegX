...
Advisories](https://github.com/microsegx/microsegx/security/advisories).
...
issue](https://github.com/microsegx/docs/issues/new/choose).
- Issues or bugs that aren't security related. These should be reported as a new
  [issue](https://github.com/microsegx/microsegx/issues/new/choose).
...
terms](https://www.suse.com/lifecycle/#microsegx) to view the current support
lifecycle.
