...
Please review and follow the [Code of Conduct](https://github.com/microsegx/microsegx/blob/main/CODE_OF_CONDUCT.md).
...
-----------|-----|-------------
openzerotrust | [https://github.com/microsegx/microsegx](https://github.com/microsegx/microsegx) | This repository hosts the controller and enforcer source code.
manager | [https://github.com/microsegx/manager](https://github.com/microsegx/manager) | The repository for the admin console UI interface.
scanner | [https://github.com/microsegx/scanner](https://github.com/microsegx/scanner) | The repository for the vulnerability scanner.
