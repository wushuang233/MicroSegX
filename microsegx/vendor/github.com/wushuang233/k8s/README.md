...
[![GoDoc](https://godoc.org/github.com/microsegx/k8s?status.svg)](https://godoc.org/github.com/microsegx/k8s)
[![Build Status](https://travis-ci.org/microsegx/k8s.svg?branch=master)](https://travis-ci.org/microsegx/k8s)
...
import (
    ...
    corev1 "github.com/microsegx/k8s/apis/core/v1"
)
...
import (
    "github.com/microsegx/k8s"
    metav1 "github.com/microsegx/k8s/apis/meta/v1"
)
...
[unversioned-status]: https://godoc.org/github.com/microsegx/k8s/api/unversioned#Status
[k8s-error]: https://godoc.org/github.com/microsegx/k8s#APIError
[config]: https://godoc.org/github.com/microsegx/k8s#Config
[string]: https://godoc.org/github.com/microsegx/k8s#String
