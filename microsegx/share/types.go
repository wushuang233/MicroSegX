...
const CVEDatabaseFolder = "/etc/microsegx/db/"
...
const (
	MicroSegXLabelImage string = "microsegx.image"
	MicroSegXLabelRole  string = "microsegx.role"

	MicroSegXRoleController string = "controller"
	MicroSegXRoleEnforcer   string = "enforcer"
	MicroSegXRoleManager    string = "manager"
)
...
const (
	...
	PolicyActionCheckNbe string = "check_nbe"
)
