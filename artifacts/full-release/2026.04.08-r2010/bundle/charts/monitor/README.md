...
Helm chart for MicroSegX's monitoring services.
...
--------- | ----------- | ------- | -----
`registry` | MicroSegX container registry | `registry.microsegx.com` |
...
`exporter.image.repository` | exporter image name | `microsegx/prometheus-exporter` |
...
---
Contact <support@microsegx.com> for access to Docker Hub and docs.
