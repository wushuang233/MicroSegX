        ...
        datasets: [
          {
            ...
            borderColor: '#ff4d4f',
            hoverBackgroundColor: 'rgba(255, 77, 79, 0.12)',
            hoverBorderColor: '#ff4d4f',
            pointColor: '#ff4d4f',
            pointStrokeColor: '#ff4d4f',
            pointHighlightFill: '#ff4d4f',
            pointHighlightStroke: '#ff4d4f',
            pointRadius: 3,
            pointHoverRadius: 4,
            fill: true,
            tension: 0.34,
          },
          {
            ...
            borderColor: '#1677ff',
            hoverBackgroundColor: 'rgba(22, 119, 255, 0.1)',
            hoverBorderColor: '#1677ff',
            pointColor: '#1677ff',
            pointStrokeColor: '#1677ff',
            pointHighlightFill: '#1677ff',
            pointHighlightStroke: '#1677ff',
            pointRadius: 3,
            pointHoverRadius: 4,
            fill: true,
            tension: 0.34,
