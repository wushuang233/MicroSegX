package com.microsegx.service.authentication
...
import com.microsegx.model.AuthTokenJsonProtocol.{ *, given }
import com.microsegx.model.RebrandJsonProtocol.{ *, given }
